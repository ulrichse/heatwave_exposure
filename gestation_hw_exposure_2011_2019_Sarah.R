# Code to calculate exposure to heatwaves for births from 2011-2019
...
write.csv(births_hw, "S:/Projects/External_PI/Births_HeatWaves/Data/Exposed/births_hw_exposed_2011_2019.csv")
...
birth <- read.csv("S:/Projects/External_PI/Births_HeatWaves/Data/Exposed/births_hw_exposed_2011_2019_w_demographics.csv")
...
birth_table<-birth%>%select("dbr_id", "lbw", "ptb", "pih", "nicuadmit", "gestdiab", "race_cat", "m_agegroup",
                            ...
                            "exposed993", "exposed994", "expstate90ct", "expstate95ct","expstate99ct",
                            "expst90ctwm", "expst95ctwm", "expst99ctwm")
...
write.csv(tab, "S:/Projects/External_PI/Births_HeatWaves/Data/Exposed/Births_w_Heatwaves_Table1_2011_2019_Sarah.csv")

# Restrict to birth outcomes 
